...
class Size {
  ...
  _getSize = (value: number, baseWidth = 1440) => {
  ...
  _1100sdp = this._getSize(1100);
  _1200sdp = this._getSize(1200);
  _1250sdp = this._getSize(1250);
  _1300sdp = this._getSize(1300);
  _1400sdp = this._getSize(1400);
  _1410sdp = this._getSize(1410);
  _1500sdp = this._getSize(1500);
  _1700sdp = this._getSize(1700);
  _2000sdp = this._getSize(2000);
  ...
  PADDING_HORIZONTAL_COMMON = this._20sdp;
  MARGIN_HORIZONTAL_COMMON = this._20sdp;
}
